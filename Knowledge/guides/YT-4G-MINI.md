# YT-4G-MINI · 4G 便携布控球 使用指南

> 产品形态：太阳能 4G（Solar/4G）　|　分辨率：2K (2560×1440)　|　镜头：4mm 定焦
> 适用 App：影腾眼 App　|　供电方式：内置锂电池 / Type-C 充电

## 一、产品简介

4G 便携布控球（型号 **YT-4G-MINI**）属于影腾 太阳能 4G（Solar/4G） 产品线，
...
4. 连接线缆：按"供电方式（内置锂电池 / Type-C 充电）"接通电源；网络型号用网线接入交换机或 NVR 的 PoE 口。
...
5. 激活成功后，可在"影腾运维台"中按型号 **YT-4G-MINI** 纳管，统一查看在线状态与告警。
...
| 现象 | 可能原因 | 处理建议 |
| --- | --- | --- |
| 设备离线 | 供电中断 / 网络不通 | 检查内置锂电池 / Type-C 充电供电与网线，重启设备后在 App 重新连接 |
...
- 出现持续告警或无法自愈的故障时，联系影腾客服并提供型号 **YT-4G-MINI** 与设备编号。
