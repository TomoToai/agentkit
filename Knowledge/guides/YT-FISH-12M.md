# YT-FISH-12M · 1200 万鱼眼全景 使用指南

> 产品形态：鱼眼全景（Fisheye）　|　分辨率：12MP (4000×3000)　|　镜头：1.29mm 全景
> 适用 App：影腾运维台 / 影腾眼 App　|　供电方式：DC12V 或 PoE(802.3af)

## 一、产品简介

1200 万鱼眼全景（型号 **YT-FISH-12M**）属于影腾 鱼眼全景（Fisheye） 产品线，
主要面向开放式办公区、零售卖场、会议室的无盲区俯拍。
...
2. 选点定位：吸顶安装，单镜头 180°/360° 全景，无监控死角。
3. 固定机身：用随附膨胀螺丝固定支架，装好后调整镜头朝向并锁紧云台/万向节。
4. 连接线缆：按"供电方式（DC12V 或 PoE(802.3af)）"接通电源；网络型号用网线接入交换机或 NVR 的 PoE 口。
...
5. 激活成功后，可在"影腾运维台"中按型号 **YT-FISH-12M** 纳管，统一查看在线状态与告警。
...
| 现象 | 可能原因 | 处理建议 |
| --- | --- | --- |
| 设备离线 | 供电中断 / 网络不通 | 检查DC12V 或 PoE(802.3af)供电与网线，重启设备后在 App 重新连接 |
...
- 出现持续告警或无法自愈的故障时，联系影腾客服并提供型号 **YT-FISH-12M** 与设备编号。
