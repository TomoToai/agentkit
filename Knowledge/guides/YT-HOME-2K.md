# YT-HOME-2K · 家用云台机 2K 使用指南

> 产品形态：家用/商用云台机（Home）　|　分辨率：2K (2560×1440)　|　镜头：4mm 定焦
> 适用 App：影腾眼 App　|　供电方式：Type-C DC5V

## 一、产品简介

家用云台机 2K（型号 **YT-HOME-2K**）属于影腾 家用/商用云台机（Home） 产品线，
...
5. 激活成功后，可在"影腾运维台"中按型号 **YT-HOME-2K** 纳管，统一查看在线状态与告警。
...
- 出现持续告警或无法自愈的故障时，联系影腾客服并提供型号 **YT-HOME-2K** 与设备编号。
