# YT-SOLAR-BULLET · 太阳能 4G 枪机 使用指南

> 产品形态：太阳能 4G（Solar/4G）　|　分辨率：2K (2560×1440)　|　镜头：4mm 定焦
> 适用 App：影腾眼 App　|　供电方式：太阳能板 + 内置锂电池

## 一、产品简介

太阳能 4G 枪机（型号 **YT-SOLAR-BULLET**）属于影腾 太阳能 4G（Solar/4G） 产品线，
主要面向工地、农田、鱼塘、边远无网无电点位的独立布控。
...
2. 选点定位：抱杆安装，太阳能板朝正南、倾角约等于当地纬度，插入 4G 流量卡。
3. 固定机身：用随附膨胀螺丝固定支架，装好后调整镜头朝向并锁紧云台/万向节。
4. 连接线缆：按"供电方式（太阳能板 + 内置锂电池）"接通电源；网络型号用网线接入交换机或 NVR 的 PoE 口。
...
5. 激活成功后，可在"影腾运维台"中按型号 **YT-SOLAR-BULLET** 纳管，统一查看在线状态与告警。
...
| 现象 | 可能原因 | 处理建议 |
| --- | --- | --- |
| 设备离线 | 供电中断 / 网络不通 | 检查太阳能板 + 内置锂电池供电与网线，重启设备后在 App 重新连接 |
...
- 出现持续告警或无法自愈的故障时，联系影腾客服并提供型号 **YT-SOLAR-BULLET** 与设备编号。
