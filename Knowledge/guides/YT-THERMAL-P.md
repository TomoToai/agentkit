# YT-THERMAL-P · 热成像云台机 使用指南

> 产品形态：热成像（Thermal）　|　分辨率：可见光 2K + 热成像 640×512　|　镜头：可见光 25 倍变焦 + 热成像 定焦
> 适用 App：影腾运维台　|　供电方式：DC24V 或 HiPoE(802.3bt)

## 一、产品简介

热成像云台机（型号 **YT-THERMAL-P**）属于影腾 热成像（Thermal） 产品线，
...
5. 激活成功后，可在"影腾运维台"中按型号 **YT-THERMAL-P** 纳管，统一查看在线状态与告警。
...
- 出现持续告警或无法自愈的故障时，联系影腾客服并提供型号 **YT-THERMAL-P** 与设备编号。
